...
@ApplicationScoped
@Named
public class PollJobBean {
    
    private static final String ID = "PollJob";
    
    private Collection<Long> jobIds = new ArrayList<Long>();

    public String startJob() throws Exception {
        JobOperator jobOperator = BatchRuntime.getJobOperator();
        add(jobOperator.start(ID, null));
        return "joblist";
    }
    ...
    public Collection<JobExecution> getJobExecutions() {
        Collection<JobExecution> result = new ArrayList<>(jobIds.size());
        JobOperator jobOperator = BatchRuntime.getJobOperator();
        for (Long id : jobIds) {
